...
Event registrations have no Studio or admin API management surface. They are
written by the production ingest script and read directly from the database by
public event queries. Provider translation remains at the import boundary.
