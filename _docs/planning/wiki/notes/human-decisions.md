...
- [HUMAN] Deploy the development environment to `dev.dtcdev.click` in AWS account `817685572750` and manage it with Terraform in the sandbox infrastructure tree.
