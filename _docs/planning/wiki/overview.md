...
- [HUMAN] The development stack belongs at `dev.dtcdev.click` in the sandbox AWS account and uses Terraform designed for later production-account instantiation.
