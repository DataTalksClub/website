# Adopted course-platform schema and data inventory
...
- Snapshot SHA: `4cc6ad41caba14da7fad10ea077e1ee10389addd`
- Source pin commit: `98a235283904b4ef9ad29e196298540756cf1bcc`
- Snapshot at (UTC): `2026-08-14T01:17:50Z`
- Repository provenance observed at (UTC): `2026-08-14T01:17:51Z`
...
Migration counts intentionally keep two baselines separate. Current `main` has 12, 41, and 5 numbered migrations for `accounts`, `courses`, and `data`; the pinned CMP graph has 10, 40, and 5. The current target graph has not been squashed. The generated adopted behavior inventory remains the route/command authority: 89 routes, 13 pinned CMP commands, five target-owned commands, and an 18-command current registry. This document links that inventory rather than copying its route or command tables.
...
| courses.Course | courses | Course | courses_course | courses/models/course.py | courses/migrations/0001_initial.py | pinned-cmp | #30 | definition | [declaration](../../courses/models/course.py); [migration](../../courses/migrations/0001_initial.py) |
| courses.RegistrationCampaign | courses | RegistrationCampaign | courses_registrationcampaign | courses/models/course.py | courses/migrations/0037_registrationcampaign_courseregistration.py | pinned-cmp | #30 | definition | [declaration](../../courses/models/course.py); [migration](../../courses/migrations/0037_registrationcampaign_courseregistration.py) |
| courses.CourseRegistration | courses | CourseRegistration | courses_courseregistration | courses/models/course.py | courses/migrations/0037_registrationcampaign_courseregistration.py | pinned-cmp | #30 | operational | [declaration](../../courses/models/course.py); [migration](../../courses/migrations/0037_registrationcampaign_courseregistration.py) |
| courses.Enrollment | courses | Enrollment | courses_enrollment | courses/models/course.py | courses/migrations/0001_initial.py | pinned-cmp | #30 | learner | [declaration](../../courses/models/course.py); [migration](../../courses/migrations/0001_initial.py) |
| courses.LeaderboardComplaint | courses | LeaderboardComplaint | courses_leaderboardcomplaint | courses/models/course.py | courses/migrations/0028_leaderboardcomplaint.py | pinned-cmp | #30 | operational | [declaration](../../courses/models/course.py); [migration](../../courses/migrations/0028_leaderboardcomplaint.py) |
...
| courses.HomeworkStatistics | courses | HomeworkStatistics | courses_homeworkstatistics | courses/models/homework.py | courses/migrations/0017_alter_projectsubmission_learning_in_public_links_and_more.py | pinned-cmp | #30 | history | [declaration](../../courses/models/homework.py); [migration](../../courses/migrations/0017_alter_projectsubmission_learning_in_public_links_and_more.py) |
| courses.WrappedStatistics | courses | WrappedStatistics | courses_wrappedstatistics | courses/models/wrapped.py | courses/migrations/0025_add_wrapped_statistics.py | pinned-cmp | #30 | history | [declaration](../../courses/models/wrapped.py); [migration](../../courses/migrations/0025_add_wrapped_statistics.py) |
| courses.UserWrappedStatistics | courses | UserWrappedStatistics | courses_userwrappedstatistics | courses/models/wrapped.py | courses/migrations/0025_add_wrapped_statistics.py | pinned-cmp | #30 | history | [declaration](../../courses/models/wrapped.py); [migration](../../courses/migrations/0025_add_wrapped_statistics.py) |
...
| courses.ProjectVote | courses | ProjectVote | courses_projectvote | courses/models/project.py | courses/migrations/0035_projectvote.py | pinned-cmp | #30 | learner | [declaration](../../courses/models/project.py); [migration](../../courses/migrations/0035_projectvote.py) |
...
| courses.ProjectEvaluationScore | courses | ProjectEvaluationScore | courses_projectevaluationscore | courses/models/project.py | courses/migrations/0012_project_points_for_peer_review_and_more.py | pinned-cmp | #30 | learner | [declaration](../../courses/models/project.py); [migration](../../courses/migrations/0012_project_points_for_peer_review_and_more.py) |
| courses.ProjectStatistics | courses | ProjectStatistics | courses_projectstatistics | courses/models/project.py | courses/migrations/0022_projectstatistics.py | pinned-cmp | #30 | history | [declaration](../../courses/models/project.py); [migration](../../courses/migrations/0022_projectstatistics.py) |
| courses.CourseRegistrationCountSourceRun | courses | CourseRegistrationCountSourceRun | courses_courseregistrationcountsourcerun | courses/models/registration_counts.py | courses/migrations/0041_courseregistrationcountsourcerun_and_more.py | target-overlay | #133 | history | [declaration](../../courses/models/registration_counts.py); [migration](../../courses/migrations/0041_courseregistrationcountsourcerun_and_more.py) |
| courses.CourseRegistrationCountRevision | courses | CourseRegistrationCountRevision | courses_courseregistrationcountrevision | courses/models/registration_counts.py | courses/migrations/0041_courseregistrationcountsourcerun_and_more.py | target-overlay | #133 | history | [declaration](../../courses/models/registration_counts.py); [migration](../../courses/migrations/0041_courseregistrationcountsourcerun_and_more.py) |
| courses.CourseRegistrationCountSlot | courses | CourseRegistrationCountSlot | courses_courseregistrationcountslot | courses/models/registration_counts.py | courses/migrations/0041_courseregistrationcountsourcerun_and_more.py | target-overlay | #133 | operational | [declaration](../../courses/models/registration_counts.py); [migration](../../courses/migrations/0041_courseregistrationcountsourcerun_and_more.py) |
...
The six `target-overlay` rows are additive; they do not alter the 26 `pinned-cmp` model identities. `CustomUser` retains its pinned identity while its target-owned identity fields are extended by migrations 0011 and 0012.
...
| courses | 41 | 40 | [current graph](../../courses/migrations/0001_initial.py); [behavior inventory](../adoption/course-platform/behavior-inventory.md) | [pinned ledger](../adoption/course-platform/copied-files.tsv); [verification](../adoption/course-platform/verification.md) | 0041 registration-count overlays are target additions; no squash |
...
The checked-in [migration-squash gate](../adoption/course-platform/migration-squash-gate.md) remains open. Original migrations are retained until an anonymized production-like parity rehearsal exists; this inventory does not read or create such a snapshot.

## Relationship edges

Every declared `ForeignKey`, `OneToOneField`, and `ManyToManyField` in the 32-model target surface appears once below. `User` and `settings.AUTH_USER_MODEL` resolve to the adopted `accounts.CustomUser` identity; no relationship is inferred from reverse accessors.
...
| courses.Course.students | courses.Course.students | ManyToManyField | accounts.CustomUser through courses.Enrollment | learner | pinned-cmp; #30 | [declaration](../../courses/models/course.py) | #14; #15 |
| courses.RegistrationCampaign.current_course | courses.RegistrationCampaign.current_course | ForeignKey | courses.Course | definition | pinned-cmp; #30 | [declaration](../../courses/models/course.py) | #14; #15 |
| courses.CourseRegistration.campaign | courses.CourseRegistration.campaign | ForeignKey | courses.RegistrationCampaign | operational | pinned-cmp; #30 | [declaration](../../courses/models/course.py) | #15; #23 |
| courses.CourseRegistration.course | courses.CourseRegistration.course | ForeignKey | courses.Course | operational | pinned-cmp; #30 | [declaration](../../courses/models/course.py) | #14; #15; #23 |
| courses.CourseRegistration.user | courses.CourseRegistration.user | ForeignKey | accounts.CustomUser | operational | pinned-cmp; #30 | [declaration](../../courses/models/course.py) | #23 |
| courses.Enrollment.student | courses.Enrollment.student | ForeignKey | accounts.CustomUser | learner | pinned-cmp; #30 | [declaration](../../courses/models/course.py) | #14; #23 |
| courses.Enrollment.course | courses.Enrollment.course | ForeignKey | courses.Course | learner | pinned-cmp; #30 | [declaration](../../courses/models/course.py) | #14; #15 |
| courses.LeaderboardComplaint.enrollment | courses.LeaderboardComplaint.enrollment | ForeignKey | courses.Enrollment | operational | pinned-cmp; #30 | [declaration](../../courses/models/course.py) | #14; #23 |
| courses.LeaderboardComplaint.reporter | courses.LeaderboardComplaint.reporter | ForeignKey | accounts.CustomUser | operational | pinned-cmp; #30 | [declaration](../../courses/models/course.py) | #23 |
| courses.LeaderboardComplaint.resolved_by | courses.LeaderboardComplaint.resolved_by | ForeignKey | accounts.CustomUser | operational | pinned-cmp; #30 | [declaration](../../courses/models/course.py) | #23 |
| courses.Homework.course | courses.Homework.course | ForeignKey | courses.Course | definition | pinned-cmp; #30 | [declaration](../../courses/models/homework.py) | #14; #15 |
...
| courses.Project.course | courses.Project.course | ForeignKey | courses.Course | definition | pinned-cmp; #30 | [declaration](../../courses/models/project.py) | #14; #15 |
...
| courses.ReviewCriteria.course | courses.ReviewCriteria.course | ForeignKey | courses.Course | definition | pinned-cmp; #30 | [declaration](../../courses/models/project.py) | #14 |
...
| courses.CourseRegistrationCountRevision.cohort | courses.CourseRegistrationCountRevision.cohort | ForeignKey | courses.Course | history | target-overlay; #133 | [declaration](../../courses/models/registration_counts.py) | #133; #14; #15 |
...
| courses.CourseRegistrationCountSlot.cohort | courses.CourseRegistrationCountSlot.cohort | ForeignKey | courses.Course | operational | target-overlay; #133 | [declaration](../../courses/models/registration_counts.py) | #133; #14; #15 |
...
| --- | --- | --- | --- |
| [#14](https://github.com/DataTalksClub/website/issues/14) | OPEN | Confirm cohort-owned curriculum, duplication isolation, and whether current definition/learner/history edges map to Course versus Cohort. | [verification](../adoption/course-platform/verification.md) |
...
Run `uv run --frozen python scripts/validate_course_platform_schema_inventory.py`. It fails closed on the exact current-main/source-pin binding, 32-model coverage, pinned-versus-overlay provenance, migration counts, 44 relationship edges, 17 boundaries, controlled vocabularies, duplicate/unknown rows, evidence-path links, and all six unresolved hand-offs. The focused tests mutate those contracts, including SHA, duplicate/unknown model, migration count, vocabulary, evidence, and hand-off drift.

This remains a static #72 input. It contains no production data or private export, makes no source-pin update, and does not implement Course-to-Cohort migration, mapping, redirects, privacy, email, or API cutover.
