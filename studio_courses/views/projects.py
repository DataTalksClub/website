...
from courses.package_notifications import send_project_score_notification
...
from studio_courses.deadline_extension import (
    extend_deadlines,
...
def project_submissions(request, course_slug, project_slug):
    ...
    response = render(request, "studio_courses/project_submissions.html", context)
    return response
...
def project_submission_edit(
    ...
    response = render(
        request, "studio_courses/project_submission_edit.html", context
    )
    return response
