from studio_courses.tests.homework_view_base import (
    AnswerData,
    HomeworkStudioCoursesViewTestBase,
    HomeworkSubmissionScoreExpectation,
)


class HomeworkSubmissionEditViewTests(HomeworkStudioCoursesViewTestBase):
