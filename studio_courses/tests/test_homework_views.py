...
class HomeworkStudioCoursesSubmissionViewTests(HomeworkStudioCoursesViewTestBase):
    ...
    def test_studio_courses_homework_submissions_staff_allowed(self):
        """Test that staff users can view homework submissions in Studio Courses"""
        self.client.login(username="admin@test.com", password="admin123")
        url = reverse(
...
class HomeworkStudioCoursesActionRedirectTests(HomeworkStudioCoursesViewTestBase):
...
class HomeworkStudioCoursesExtendDeadlineTests(HomeworkStudioCoursesViewTestBase):
...
class HomeworkStudioCoursesSearchTests(HomeworkStudioCoursesViewTestBase):
...
class HomeworkStudioCoursesScoringActionTests(HomeworkStudioCoursesViewTestBase):
    @patch("studio_courses.views.homework.send_homework_score_notification")
...
class HomeworkStudioCoursesRescoreTests(HomeworkStudioCoursesViewTestBase):
    def setUp(self):
        super().setUp()
        self.homework.due_date = timezone.now() - timedelta(hours=1)
        self.homework.state = HomeworkState.SCORED.value
...
class HomeworkStudioCoursesInlineAnswersTests(HomeworkStudioCoursesViewTestBase):
    def setUp(self):
        super().setUp()
