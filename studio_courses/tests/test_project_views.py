from studio_courses.tests.project_view_base import (
    ProjectStudioCoursesViewTestBase,
    admin_credentials,
)
...
class ProjectStudioCoursesViewTests(ProjectStudioCoursesViewTestBase):
