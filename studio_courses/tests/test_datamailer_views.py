...
class DatamailerStudioCoursesViewTestCase(TestCase):
    def setUp(self):
        self.client = Client()
...
class DatamailerOperationsAccessTest(DatamailerStudioCoursesViewTestCase):
...
class DatamailerOperationsPageTest(DatamailerStudioCoursesViewTestCase):
...
class DatamailerOperationsRequeueTest(DatamailerStudioCoursesViewTestCase):
...
class DatamailerEventsAccessTest(DatamailerStudioCoursesViewTestCase):
...
class DatamailerEventsPageTest(DatamailerStudioCoursesViewTestCase):
...
class DatamailerEventsFilterTest(DatamailerStudioCoursesViewTestCase):
