    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                (
                    "key",
                    models.CharField(
                        default="default", editable=False, max_length=32, primary_key=True, serialize=False
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            options={
                "ordering": ("worker_id",),
                "indexes": [
                    models.Index(fields=["expires_at"], name="jobs_heartbeat_expiry")
                ],
                "constraints": [
                    models.CheckConstraint(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        ...
                        name="jobs_durable_lease",
                    ),
                    models.Index(
                        fields=["correlation_id"],
                        name="jobs_durable_correlation",
                    ),
                ],
                "constraints": [
                    models.CheckConstraint(
                    ...
                    models.CheckConstraint(
                        condition=Q(
                            Q(
                                ...
                                ("lease_token__isnull", False),
                                ("status", "running"),
                                Q(("claimed_by", ""), _negated=True),
                            ),
                            Q(
                                Q(("status", "running"), _negated=True),
                                ("lease_token__isnull", True),
