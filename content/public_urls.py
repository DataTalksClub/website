...
urlpatterns = [
    ...
    path("blog/<path:slug>", public_views.article_detail, name="public-article"),
    ...
    path("podcast/<path:slug>", public_views.podcast_detail, name="public-podcast"),
    ...
    path("books/<path:slug>", public_views.book_detail, name="public-book"),
    path("people", public_views.people_hub, name="people"),
    path("people.html", public_views.permanent_public_redirect, {"target": "/people"}),
    path("people/", public_views.permanent_public_redirect, {"target": "/people"}),
    path(
        "people/<path:slug>.html",
        public_views.permanent_detail_redirect,
        {"collection": "people"},
    ),
    path(
    ...
    path("people/<path:slug>", public_views.person_detail, name="public-person"),
