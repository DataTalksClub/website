...
ROUTE_CACHE_CLASSES: dict[str, str] = {
    ...
    "content.public_views.editorial_detail_alias_redirect": PERMANENT_REDIRECT,
    ...
    "community_base.studio.impersonation.start": PRIVATE_DYNAMIC,
    "community_base.studio.impersonation.stop": PRIVATE_DYNAMIC,
    "community_base.studio.user_views.note_create": PRIVATE_DYNAMIC,
    "community_base.studio.user_views.note_delete": PRIVATE_DYNAMIC,
    "community_base.studio.user_views.note_edit": PRIVATE_DYNAMIC,
    "community_base.studio.user_views.user_detail": PRIVATE_DYNAMIC,
    "community_base.studio.user_views.user_export": PRIVATE_DYNAMIC,
    "community_base.studio.user_views.user_list": PRIVATE_DYNAMIC,
    "community_base.studio.user_views.user_tag_add": PRIVATE_DYNAMIC,
    "community_base.studio.user_views.user_tag_remove": PRIVATE_DYNAMIC,
    "community_base.studio.views.dashboard": PRIVATE_DYNAMIC,
    "community_base.studio.views.global_search": PRIVATE_DYNAMIC,
