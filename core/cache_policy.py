...
ROUTE_CACHE_CLASSES: dict[str, str] = {
    ...
    "api.views.webhooks.datamailer_event_webhook": OPERATIONAL,
    ...
    "api.views.datamailer_send_audits.datamailer_send_audits_view": PRIVATE_DYNAMIC,
    ...
    "courses.views.course_project_submissions.list_all_project_submissions_view": PRIVATE_DYNAMIC,
    ...
    "courses.views.project_submissions.projects_list_view": PRIVATE_DYNAMIC,
    ...
    "events.qna.studio_views.event_qna_cohost": PRIVATE_DYNAMIC,
    "events.qna.studio_views.event_qna_cohost_revoke": PRIVATE_DYNAMIC,
    "events.qna.studio_views.event_qna_detail": PRIVATE_DYNAMIC,
    "events.qna.studio_views.event_qna_moderate": PRIVATE_DYNAMIC,
    "events.qna.studio_views.event_qna_retry": PRIVATE_DYNAMIC,
    "events.qna.studio_views.event_qna_update": PRIVATE_DYNAMIC,
    "events.qna.views.public_qna": PRIVATE_DYNAMIC,
    "events.qna.views.qna_cohost_gate": PRIVATE_DYNAMIC,
    "events.qna.views.qna_host": PRIVATE_DYNAMIC,
    "events.qna.views.qna_present": PRIVATE_DYNAMIC,
    "events.qna.views.qna_qr": PRIVATE_DYNAMIC,
    "events.qna.views.qna_question": PRIVATE_DYNAMIC,
    "events.qna.views.qna_questions": PRIVATE_DYNAMIC,
    "events.qna.views.qna_vote": PRIVATE_DYNAMIC,
    ...
    "studio_courses.views.datamailer.datamailer_events": PRIVATE_DYNAMIC,
    "studio_courses.views.datamailer.datamailer_operations": PRIVATE_DYNAMIC,
