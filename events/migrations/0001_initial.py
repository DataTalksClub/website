    ...
    operations = [
            ...
            options={
                ...
                "constraints": [
                    ...
                    models.CheckConstraint(
                        condition=models.Q(("title__gt", "")), name="events_event_title_nonempty"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(
                            ("public_id__isnull", True), ("public_id__gt", 0), _connector="OR"
                        ),
                        name="events_event_public_id_positive",
                    ),
                    models.CheckConstraint(
                        condition=models.Q(
                            ("source_repository__gt", ""),
                            ("source_revision__gt", ""),
                            ("source_key__gt", ""),
                        ),
        ...
        migrations.CreateModel(
            ...
            options={
                "constraints": [
                    models.CheckConstraint(
                        condition=models.Q(("id", 1)), name="events_public_id_sequence_singleton"
                    ),
                    models.CheckConstraint(
                        condition=models.Q(("next_public_id__gt", 0)),
        ...
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["scope_digest", "window_seconds"], name="events_qna_rate_scope"
                    )
                ],
                "constraints": [
                    models.UniqueConstraint(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "default_sort",
                    models.CharField(
                        choices=[("popular", "Popular"), ("recent", "Recent")],
                        default="popular",
                        max_length=16,
                    ),
                ),
                ...
                # A plain uuid column here, not the package FK: this migration is
                # already applied on deployed databases whose recorded state
                # predates cb_jobs, and a dependency on cb_jobs.0001 makes
                # migrate refuse to run on them (InconsistentMigrationHistory).
                # events.0006 converges the column to the package FK for both
                # fresh and deployed databases.
                (
                    "provisioning_job",
                    models.UUIDField(blank=True, null=True, db_column="provisioning_job_id"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "provider",
                    models.CharField(
                        choices=[("luma", "Luma"), ("eventbrite", "Eventbrite")], max_length=16
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="events.historicaleventmapping",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT,
                related_name="aggregate_revisions",
                to="events.historicalregistrationsourcerun",
            ),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "constraints": [
                    models.CheckConstraint(
                        condition=models.Q(
                            ("source_path__startswith", "/events/"),
                            models.Q(("source_path__contains", "?"), _negated=True),
                            models.Q(("source_path__contains", "#"), _negated=True),
                        ),
        ...
        migrations.AddConstraint(
            model_name="eventqnasession",
            constraint=models.CheckConstraint(
                condition=models.Q(("backend_key__gt", "")),
        ...
        migrations.AddConstraint(
            model_name="eventqnasession",
            constraint=models.CheckConstraint(
                condition=models.Q(("q_answered__lte", models.F("q_total"))),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    ("retention_days__isnull", True), ("retention_days__gte", 1), _connector="OR"
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["session", "status", "created_at"], name="events_qna_q_status_time"
            ),
        ),
        migrations.AddIndex(
            model_name="eventqnaquestion",
        ...
        migrations.AddConstraint(
            model_name="eventqnaquestion",
            constraint=models.CheckConstraint(
                condition=models.Q(("text__gt", ""), ("participant_digest__gt", "")),
        ...
        migrations.AddConstraint(
            model_name="eventqnaquestion",
            constraint=models.CheckConstraint(
                condition=models.Q(("score__gte", 0)), name="events_qna_question_score_nonnegative"
            ),
        ),
        migrations.AddConstraint(
            model_name="eventqnacohostinvite",
            constraint=models.UniqueConstraint(
                fields=("session", "name"), name="events_qna_cohost_name_unique"
            ),
        ),
        migrations.AddConstraint(
            model_name="eventqnavote",
            constraint=models.UniqueConstraint(
                fields=("question", "participant_digest"), name="events_qna_vote_participant_unique"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(("revision__gte", 1)),
                name="events_hist_mapping_revision_positive",
            ),
        ),
        migrations.AddConstraint(
            model_name="historicaleventmapping",
            constraint=models.CheckConstraint(
                condition=models.Q(("mapping_set_revision__gte", 1)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    ...
                    models.Q(
                        ("reason_code__gt", ""), ("reviewer_ref__gt", ""), ("state", "excluded")
                    ),
        ...
        migrations.AddConstraint(
            model_name="historicalregistrationaggregateslot",
            constraint=models.CheckConstraint(
                condition=models.Q(("revision__gte", 1)), name="events_hist_slot_revision_positive"
            ),
        ),
        migrations.AddConstraint(
            model_name="historicalregistrationaggregateslot",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("replacing_revision", "slot"), name="events_hist_displacement_unique"
            ),
        ),
        migrations.AddConstraint(
            model_name="historicalregistrationpointerdisplacement",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["provider", "state", "-created_at"], name="events_hist_run_state"
            ),
        ),
        migrations.AddIndex(
            model_name="historicalregistrationsourcerun",
        ...
        migrations.AddConstraint(
            model_name="historicalregistrationsourcerun",
            constraint=models.CheckConstraint(
                condition=models.Q(("revision__gte", 1)), name="events_hist_run_revision_positive"
            ),
        ),
        migrations.AddConstraint(
            model_name="historicalregistrationsourcerun",
            constraint=models.CheckConstraint(
                condition=models.Q(("eligible_row_total__lte", models.F("parsed_row_total"))),
        ...
        migrations.AddConstraint(
            model_name="historicalregistrationsourcerun",
            constraint=models.CheckConstraint(
                condition=models.Q(("excluded_row_total__lte", models.F("parsed_row_total"))),
        ...
        migrations.AddIndex(
            model_name="historicalregistrationaggregaterevision",
            index=models.Index(
                fields=["mapping", "state", "-created_at"], name="events_hist_agg_state"
            ),
        ),
        migrations.AddIndex(
            model_name="historicalregistrationaggregaterevision",
