...
class DatamailerProjectScoreTestBase(TestCase):
    ...
    def assert_project_score_member(self, member, submission):
        ...
        self.assertEqual(
            ...
            "https://courses.example.com/courses/ml-zoomcamp/cohorts/2026/project/project-1",
        )
    ...
    def assert_project_score_context(self, payload):
        self.assertEqual(
            ...
            "https://courses.example.com/courses/ml-zoomcamp/cohorts/2026/project/project-1/results",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "https://courses.example.com/courses/ml-zoomcamp/cohorts/2026/leaderboard",
        )
