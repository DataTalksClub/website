...
def _sponsor_form_payload(post) -> dict[str, object]:
    payload: dict[str, object] = {
        ...
        "logo_asset_key": post.get("logo_asset_key", ""),
        "featured_on_home": post.get("featured_on_home") == "true",
...
def _sponsor_detail_context(
    ...
    *,
    ...
    defaults = {
        ...
        "logo_asset_key": sponsor.get("logo_asset_key", ""),
        "featured_on_home": bool(sponsor.get("featured_on_home", False)),
