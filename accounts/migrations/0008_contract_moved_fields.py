...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RemoveField(model_name="user", name="certificate_name"),
        migrations.RemoveField(model_name="user", name="country"),
        migrations.RemoveField(model_name="user", name="region"),
        migrations.RemoveField(model_name="user", name="registration_role"),
        migrations.RemoveField(model_name="user", name="github_url"),
        migrations.RemoveField(model_name="user", name="linkedin_url"),
        migrations.RemoveField(model_name="user", name="personal_website_url"),
        migrations.RemoveField(model_name="user", name="about_me"),
        migrations.RemoveField(model_name="user", name="dark_mode"),
        migrations.RemoveField(model_name="user", name="normalized_email"),
        migrations.RemoveField(model_name="user", name="identity_state"),
    ]
