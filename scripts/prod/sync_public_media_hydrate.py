...
models mean. The set of recorded objects
(``~/prod/dtc-data/content-staging/public_projection/media.json``, outside
this repository -- see ``_docs/architecture/database-only-content.md``)
