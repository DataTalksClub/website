...
class ScoringImportAtomicityTests(TestCase):
    ...
    def _import(self) -> tuple[object, int, int, int, int, int]:
    ...
    def test_a_failure_during_answer_insertion_keeps_the_prior_state(self) -> None:
        ...
        _homework, _count, _recovered, _fallback, _links_recovered, _links_empty = self._import()
    ...
    def test_normal_replay_creates_no_duplicate_answers(self) -> None:
        ...
        self._import()
        _homework, count, _recovered, _fallback, _links_recovered, _links_empty = self._import()
